 ...
 */
$actionMap = [
    "getDataTableHeroesStatsListAction" => "getDataTableHeroesStatsListAction",
];
    ...
    if ($resrows > 0) {
        ...
        if ($queuedResultRows > 0) {
            ...
            if ($requestLocked) {
                ...
                //Execute request
                $actionMap[$action]($cache_id, $payload, $db, $creds);
...
function getDataTableHeroesStatsListAction($cache_id, $payload, MySqlDatabase &$db, $creds) {
